...
Because the public O2 demo data can change, patient search tests skip themselves when the configured keyword returns no patients. This keeps the result evidence-based when public demo data is unavailable.
