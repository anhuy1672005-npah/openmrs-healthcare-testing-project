...
def test_register_patient_name_step_accepts_dummy_data_when_next_is_available(logged_in_driver):
    ...
    assert registration_page.has_progressed_past_name_step(), (
        "After entering required name data and clicking Next, the registration wizard "
        "should move beyond the name step or show the next-step content."
    )
