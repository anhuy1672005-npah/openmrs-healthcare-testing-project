...
This traceability matrix maps manual test cases to planned Selenium UI automation and future Postman API testing.
...
| Open patient profile from search result | TC_PROFILE_001      | Patient Profile  | High                | tests/test_patient_search.py       | PatientSearchPage, PatientProfilePage | Yes           | Selected | Connects search result with patient profile.    |
