...
| SC_API_004  | API Negative Case  | Verify invalid UUID and no-auth API behavior | Negative  | High     | No                   | Yes           |
...
| Security-related | Basic check related to session and no-auth access behavior                      |
