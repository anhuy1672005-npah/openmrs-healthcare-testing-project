...
7. Verify selected OpenMRS REST API endpoints related to authentication, current user, patient/person search, patient/person detail, invalid request, and unauthorized access.
